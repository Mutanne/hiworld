...
CREATE TABLE `cidade` (
  ...
  CONSTRAINT `cidade_ibfk_1` FOREIGN KEY (`CODIGOESTADO`) REFERENCES `estado` (`CODIGOESTADO`)
...
INSERT INTO `cidade` VALUES (1,1,'Anastácio'),(2,1,'Campo Grande'),(3,2,'São Paulo');
