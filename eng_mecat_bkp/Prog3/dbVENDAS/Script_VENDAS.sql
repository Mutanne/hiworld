...
insert into ESTADO (CODIGOESTADO,NOMEESTADO,UF) values (3,'Distrito Federal','DF');
insert into ESTADO (CODIGOESTADO,NOMEESTADO,UF) values (4,'Rio de Janeiro','RJ');
...
insert into CIDADE (CODIGOCIDADE,CODIGOESTADO,NOMECIDADE) values (4,3,'Brasília');
insert into CIDADE (CODIGOCIDADE,CODIGOESTADO,NOMECIDADE) values (5,4,'Rio de Janeiro');

INSERT INTO BAIRRO (CODIGOBAIRRO,NOMEBAIRRO) VALUES(1,'Santo Amaro');
INSERT INTO BAIRRO (CODIGOBAIRRO,NOMEBAIRRO) VALUES(2,'Centro');
INSERT INTO BAIRRO (CODIGOBAIRRO,NOMEBAIRRO) VALUES(3,'Babilonia');
INSERT INTO BAIRRO (CODIGOBAIRRO,NOMEBAIRRO) VALUES(4,'Morumbi');
INSERT INTO BAIRRO (CODIGOBAIRRO,NOMEBAIRRO) VALUES(5,'Washingtom');
...
INSERT INTO LOGR (CODLOGR,NOMELOGR) VALUES(1,'Afonso Pena');
INSERT INTO LOGR (CODLOGR,NOMELOGR) VALUES(2,'Presidente Vargas');
INSERT INTO LOGR (CODLOGR,NOMELOGR) VALUES(3,'Ladeira');
INSERT INTO LOGR (CODLOGR,NOMELOGR) VALUES(4,'Guimarães Rosa');
...
INSERT INTO ENDERECO(CODIGOENDERECO,CODLOGR,CODTIPOLOGR,NUMERO,COMPLEMENTO,CODCEP,CODIGOBAIRRO,CODIGOCIDADE,CODIGOESTADO) VALUES(2,3,2,30,'-',2,3,2,1);
INSERT INTO ENDERECO(CODIGOENDERECO,CODLOGR,CODTIPOLOGR,NUMERO,COMPLEMENTO,CODCEP,CODIGOBAIRRO,CODIGOCIDADE,CODIGOESTADO) VALUES(3,4,3,201,'APT. 50',2,3,3,2);
INSERT INTO ENDERECO(CODIGOENDERECO,CODLOGR,CODTIPOLOGR,NUMERO,COMPLEMENTO,CODCEP,CODIGOBAIRRO,CODIGOCIDADE,CODIGOESTADO) VALUES(4,2,2,15,'CASA 3',2,4,5,4);
INSERT INTO ENDERECO(CODIGOENDERECO,CODLOGR,CODTIPOLOGR,NUMERO,COMPLEMENTO,CODCEP,CODIGOBAIRRO,CODIGOCIDADE,CODIGOESTADO) VALUES(5,4,1,987,'-',4,5,4,3);
...
insert into CLIENTE(CODIGOCLIENTE,CODIGOENDERECO,NOMECLIENTE,TELEFONE,CPF) VALUES(4,4,'GOKU SILVA JUNIOR',6765849525,98123658754);

INSERT INTO VENDEDOR(CODIGOVENDEDOR,NOMEVENDEDOR,SALARIOFIXO,FAIXACOMISSAO) VALUES(1,'Joao',1024,'C');
INSERT INTO VENDEDOR(CODIGOVENDEDOR,NOMEVENDEDOR,SALARIOFIXO,FAIXACOMISSAO) VALUES(2,'Maria',2510,'B');
INSERT INTO VENDEDOR(CODIGOVENDEDOR,NOMEVENDEDOR,SALARIOFIXO,FAIXACOMISSAO) VALUES(3,'Jose',3150,'A');
...
INSERT INTO PEDIDO (NUMPEDIDO,CODIGOCLIENTE,CODIGOVENDEDOR,PRAZOENTREGA) VALUES

--#Exercicios
--#1---------------
SELECT * FROM produto;
--#2---------------
select DESCRICAO,VALORUNIT,UNIDADE FROM PRODUTO;
--#3---------------
SELECT DESCRICAO,VALORUNIT FROM PRODUTO WHERE PRODUTO.VALORUNIT>1 AND PRODUTO.VALORUNIT<6;
--#4---------------
SELECT * FROM CLIENTE;
--#5---------------
...
--#6----------------
SELECT NOMECLIENTE,NOMECIDADE FROM CLIENTE
...
WHERE CIDADE.CODIGOCIDADE=3;
--#7----------------
SELECT NOMECLIENTE,NOMECIDADE,NOMEESTADO FROM cliente 
INNER JOIN ENDERECO ON CLIENTE.CODIGOENDERECO=ENDERECO.CODIGOENDERECO
...
SELECT * FROM PRODUTO;
--#9----------------
ALTER TABLE PEDIDO ADD COLUMN 'DATA DO PEDIDO';
--#10---------------
UPDATE PEDIDO SET DATE'DATA DO PEDIDO' AS(
--#15---------------
